...
\title[Polygon meshing algorithm based on terminal-edge regions]{Polygon meshing algorithm based on terminal-edge regions}
...
\author[2]{\fnm{Nancy} \sur{Hitschfeld}}\email{nancy@dcc.uchile.cl}
\equalcont{These authors contributed equally to this work.}
\author[3]{\fnm{Alejandro} \sur{Ortiz-Bernardin}}\email{aortizb@uchile.cl}
\author[4]{\fnm{Hang} \sur{Si}}\email{si@wias-berlin.de}


\affil*[1,2]{\orgdiv{Department of Computer Sciences
}, \orgname{Universidad de Chile}, \orgaddress{\street{Av. Beauchef 851}, \city{Santiago}, \postcode{8370456}, \state{RM}, \country{Chile}}}


\affil[3]{\orgdiv{Department of Mechanical Engineering}, \orgname{Universidad de Chile}, \orgaddress{\street{Av. Beauchef 851}, \city{Santiago}, \postcode{8370456}, \state{RM}, \country{Chile}}}

\affil[4]{\orgdiv{Numerical Mathematics and Scientific Computing}, \orgname{Weierstrass Institute for Applied Analysis and Stochastics }, \orgaddress{\street{Street}, \city{City}, \postcode{610101}, \state{State}, \country{Country}}}
...
\keywords{Polygon Mesh, Virtual Element method, Delaunay Triangulation, Terminal-edge region}
...
\bibliography{sn-bibliography, ref,polygonVem }% common bib file
