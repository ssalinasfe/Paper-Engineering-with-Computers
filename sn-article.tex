...
\author*[1,2]{\fnm{Sergio} \sur{Salinas}}\email{ssalinas@dcc.uchile.cl}

\author[2,3]{\fnm{Nancy} \sur{Hitschfeld}}\email{nancy@dcc.uchile.cl}
\equalcont{These authors contributed equally to this work.}

\author[1,2]{\fnm{Alejandro} \sur{Ortiz-Bernardin}}\email{aortizb@uchile.cl}
\equalcont{These authors contributed equally to this work.}


\author[1,2]{\fnm{Hang} \sur{Si}}\email{si@wias-berlin.de}
\equalcont{These authors contributed equally to this work.}
